  ...
  return (
    <div className="flex flex-col justify-between max-w-xl mt-8 xs:flex-row lg:mt-0 xs:grid xs:grid-cols-2">
      <div className="flex flex-row justify-around">
        <a
          href="https://intellectaddict.com/"
          target="_blank"
          className="group"
        >
          <FontAwesomeIcon
            icon={faBlog}
            className="xl:text-4xl text-3xl group-hover:text-[#1DA1F2] transition delay-400 ease-linear group-hover:-translate-y-2 group-hover:scale-125"
          />
        </a>
        <a
          href="https://github.com/ShrutisLegion"
          target="_blank"
          className="group"
        >
          <FontAwesomeIcon
            icon={faGithub}
            className="xl:text-4xl text-3xl group-hover:text-[#64748B] transition delay-400 ease-linear group-hover:-translate-y-2 group-hover:scale-125"
          />
        </a>
        <a
          href="https://www.linkedin.com/in/shruti-bhateja/"
          target="_blank"
          className="group"
        >
          <FontAwesomeIcon
      ...
      <div className="flex flex-row justify-around mt-4 xs:mt-0">
        ...
        <a
          href="https://discord.com/users/789704055182065696"
          target="_blank"
          className="group"
        >
          <FontAwesomeIcon
            icon={faDiscord}
            className="xl:text-4xl text-3xl group-hover:text-[#738ADB] transition delay-400 ease-linear group-hover:-translate-y-2 group-hover:scale-125"
          />
        </a>
        <a
        ...
        >
          <FontAwesomeIcon
            icon={faSpotify}
            className="xl:text-4xl text-3xl group-hover:text-[#1DB954] transition delay-400 ease-linear group-hover:-translate-y-2 group-hover:scale-125"
          />
        </a>
        <a
          href="https://twitter.com/shrutimusings"
          target="_blank"
          className="group"
        >
          <FontAwesomeIcon
            icon={faTwitter}
            className="transition delay-400 ease-linear xl:text-4xl text-3xl group-hover:text-[#1DA1F2] group-hover:-translate-y-2 group-hover:scale-125"
          />
        </a>
        <a
        ...
        >
          <FontAwesomeIcon
            icon={faSlack}
            className="transition delay-400 ease-linear xl:text-4xl text-3xl group-hover:text-[#ECB22E] group-hover:-translate-y-2 group-hover:scale-125"
          />
        </a>
        {/* <a href="">
          <FontAwesomeIcon
