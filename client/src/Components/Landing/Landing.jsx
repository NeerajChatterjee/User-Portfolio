...
export default function Landing() {
  ...
  return (
    <>
      ...
      {showTop ? (
        <div
          className="fixed bottom-0 right-0 -translate-x-4 -translate-y-4 max-w-[3rem] md:max-w-[5rem] md:-translate-x-8 md:-translate-y-8 cursor-pointer z-50" title="Scroll to top"
          onClick={scrollToTop} ref={rocketRef}
        >
        </div>
      ) : (
        <></>
